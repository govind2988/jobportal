...
function EditJob({ isOpen, onClose }) {
    ...
    const editJobNext = () => {
      ...
      const [remotetype, setRemotetype] = useState(
        localStorage.getItem("remotetype")
      );
      const [minexp, setMinexp] = useState(localStorage.getItem("minexp"));
      const [maxexp, setMaxexp] = useState(localStorage.getItem("maxexp"));
      const [minsalary, setMinsalary] = useState(
        localStorage.getItem("minsalary")
      );
      const [maxsalary, setMaxsalary] = useState(
        localStorage.getItem("maxsalary")
      );
      const [totalemployee, setTotalemployee] = useState(
        localStorage.getItem("totalemployee")
      );

      const [applytype, setApplytype] = useState(
        localStorage.getItem("applytype")
      );
              ...
              {showStep1 ? (
                <div className="step1Container">
                  ...
                  <div className="flex mt-24 justify-end">
                    <ButtonSolid buttonName={"Next"} onClick={editJobNext} />
                  </div>
                </div>
              ) : (
                <div className="step2Container">
                  ...
                  <div className="flex mt-24 justify-end">
                    <ButtonSolid buttonName={"Update"} onClick={updateJob} />
                  </div>
                </div>
              )}
            </div>
